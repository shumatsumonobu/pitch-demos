export default () => `<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
  ...
  <div class="card bg-base-100 shadow-none rounded-sm border border-base-300">
    <div class="card-body">
      <h2 class="text-lg font-normal">食事画像</h2>
      <p class="text-sm text-base-content/80">食事の画像をアップロードすると、AIが各品目の摂取率を自動判定します</p>
      <div class="flex items-center gap-2">
        ...
        <select id="sample-select" class="select select-sm select-bordered w-56 h-10 min-h-0">
          ...
          <optgroup label="魚料理">
            <option value="fish-0">魚料理 / 摂取率 0%</option>
            <option value="fish-20">魚料理 / 摂取率 20%</option>
            <option value="fish-40">魚料理 / 摂取率 40%</option>
            <option value="fish-60">魚料理 / 摂取率 60%</option>
            <option value="fish-80">魚料理 / 摂取率 80%</option>
            <option value="fish-100">魚料理 / 摂取率 100%</option>
          </optgroup>
          <optgroup label="肉料理">
            <option value="meat-0">肉料理 / 摂取率 0%</option>
            <option value="meat-20">肉料理 / 摂取率 20%</option>
            <option value="meat-40">肉料理 / 摂取率 40%</option>
            <option value="meat-60">肉料理 / 摂取率 60%</option>
            <option value="meat-80">肉料理 / 摂取率 80%</option>
            <option value="meat-100">肉料理 / 摂取率 100%</option>
          </optgroup>
        </select>
        <!-- 判定ボタン -->
